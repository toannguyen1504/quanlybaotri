...
public class TicketEventService {
    ...
    public void record(
        ...
        try {
            ...
            data.put("ticketCode", ticket.getCode());
            data.put("action", action);
            data.put("status", ticket.getStatus().name());
            data.put("priority", ticket.getPriority().name());
            data.put("actorId", actorId);
            data.put("requesterId", ticket.getRequesterId());
            data.put("assigneeId", ticket.getAssigneeId());
            data.put("equipmentId", ticket.getEquipmentId());
            data.put("description", description);
            data.put("submittedAt", ticket.getSubmittedAt());
            data.put("resolutionDueAt", ticket.getResolutionDueAt());
            data.put("resolvedAt", ticket.getResolvedAt());
            data.put("metadata", details);
            data.putAll(details);
            ...
            throw new IllegalStateException("Cannot serialize maintenance event", ex);
        }
    }
}
